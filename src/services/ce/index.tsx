...
export interface GetForecastCost1QueryParams {
  accountIdentifier: string
  perspectiveId: string
}

export type GetForecastCost1Props = Omit<GetProps<ResponseDouble, unknown, GetForecastCost1QueryParams, void>, 'path'>

/**
 * Get forecast cost for perspective
 */
export const GetForecastCost1 = (props: GetForecastCost1Props) => (
  <Get<ResponseDouble, unknown, GetForecastCost1QueryParams, void>
...
export type UseGetForecastCost1Props = Omit<
  UseGetProps<ResponseDouble, unknown, GetForecastCost1QueryParams, void>,
  'path'
>
 ...
 * Get forecast cost for perspective
 */
export const useGetForecastCost1 = (props: UseGetForecastCost1Props) =>
  useGet<ResponseDouble, unknown, GetForecastCost1QueryParams, void>(`/perspective/forecastCost`, {
    base: getConfig('ccm/api'),
    ...props
  })

export interface GetLastMonthCost1QueryParams {
  accountIdentifier: string
  perspectiveId: string
}

export type GetLastMonthCost1Props = Omit<GetProps<ResponseDouble, unknown, GetLastMonthCost1QueryParams, void>, 'path'>

/**
 * Get last month cost for perspective
 */
export const GetLastMonthCost1 = (props: GetLastMonthCost1Props) => (
  <Get<ResponseDouble, unknown, GetLastMonthCost1QueryParams, void>
...
export type UseGetLastMonthCost1Props = Omit<
  UseGetProps<ResponseDouble, unknown, GetLastMonthCost1QueryParams, void>,
  'path'
>
 ...
 * Get last month cost for perspective
 */
export const useGetLastMonthCost1 = (props: UseGetLastMonthCost1Props) =>
  useGet<ResponseDouble, unknown, GetLastMonthCost1QueryParams, void>(`/perspective/lastMonthCost`, {
    base: getConfig('ccm/api'),
    ...props
  })
