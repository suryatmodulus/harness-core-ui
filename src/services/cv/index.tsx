...
export type ValidateConnectorProps = Omit<
  GetProps<RestResponseVoid, unknown, ValidateConnectorQueryParams, void>,
  'path'
>
...
export const ValidateConnector = (props: ValidateConnectorProps) => (
  <Get<RestResponseVoid, unknown, ValidateConnectorQueryParams, void>
...
export type UseValidateConnectorProps = Omit<
  UseGetProps<RestResponseVoid, unknown, ValidateConnectorQueryParams, void>,
  'path'
>
...
export const useValidateConnector = (props: UseValidateConnectorProps) =>
  useGet<RestResponseVoid, unknown, ValidateConnectorQueryParams, void>(`/onboarding/connector`, {
    base: getConfig('cv/api'),
    ...props
  })
 ...
 * connector api response
 */
export const validateConnectorPromise = (
  props: GetUsingFetchProps<RestResponseVoid, unknown, ValidateConnectorQueryParams, void>,
  signal?: RequestInit['signal']
) =>
  getUsingFetch<RestResponseVoid, unknown, ValidateConnectorQueryParams, void>(
    getConfig('cv/api'),
