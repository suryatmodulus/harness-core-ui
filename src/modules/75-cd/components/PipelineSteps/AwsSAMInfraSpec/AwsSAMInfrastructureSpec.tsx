...
const GcpInfrastructureSpecEditable: React.FC<GcpInfrastructureSpecEditableProps> = ({
  ...
  const [, setClusterOptions] = useState<SelectOption[]>([])
...
const AwsSAMInfraType = 'AwsSamInfra'
export class AwsSAMInfraSpec extends PipelineStep<GcpInfrastructureSpecStep> {
  lastFetched: number
