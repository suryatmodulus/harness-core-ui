...
export const GithubDetails = (props: GithubDetailsProps) => (
  <Get<GithubDetailsResponse, void, void, void>
    path={`/github/details`}
 ...
 * githubDetails
 */
export const useGithubDetails = (props: UseGithubDetailsProps) => useGet<GithubDetailsResponse, void, void, void>(`/github/details`, { base:getConfig("asaasin/api"),  ...props });
 ...
 * pagerdutySavings
 */
export const usePagerdutySavings = (props: UsePagerdutySavingsProps) => useGet<PagerDutySavingsResponse, void, void, void>(`/pagerduty/savings`, { base:getConfig("asaasin/api"),  ...props });
 ...
 * pagerdutyInactiveUsers
 */
export const usePagerdutyInactiveUsers = (props: UsePagerdutyInactiveUsersProps) => useGet<PagerDutyUsersResponse, void, void, void>(`/pagerduty/users/inactive`, { base:getConfig("asaasin/api"),  ...props });
 ...
 * allStatsOfApplications
 */
export const useAllStatusOfApplications = (props: UseAllStatusOfApplicationsProps) => useGet<PagerDutyUsersResponse, void, void, void>(`/stats`, { base:getConfig("asaasin/api"),  ...props });
