...
import { GCOMetricsHealthSourceInitialData } from './GCOMetricsHealthSource.mock'
...
describe('Unit tests for MapGCOMetricsToServices', () => {
  ...
  test('should have initial value assigned', async () => {
    const onSubmitMock = jest.fn()
    render(<WrapperComponent onSubmit={onSubmitMock} data={cloneDeep(GCOMetricsHealthSourceInitialData)} />)
