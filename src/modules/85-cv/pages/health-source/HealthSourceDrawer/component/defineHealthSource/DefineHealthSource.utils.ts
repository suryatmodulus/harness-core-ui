...
import { NewRelicProductNames, ConnectorRefFieldName, SplunkProductName } from './DefineHealthSource.constant'
...
export const getFeatureOption = (type: string, getString: UseStringsReturn['getString']): SelectOption[] => {
  switch (type) {
    ...
    case Connectors.SPLUNK:
      return [
        {
          value: SplunkProductName.SplunkCloud,
          label: 'Splunk Cloud'
        },
        {
          value: SplunkProductName.SplunkEnterprise,
