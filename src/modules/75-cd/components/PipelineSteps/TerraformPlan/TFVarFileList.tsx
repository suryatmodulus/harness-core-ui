...
import { TerraformPlanData, TerraformStoreTypes, VarFileArray } from '../Common/Terraform/TerraformInterfaces'
  ...
  return (
    <FieldArray
      ...
      render={({ push, remove }) => {
        return (
          <div>
            {formik?.values?.spec?.configuration?.varFiles?.map((varFile: VarFileArray, i) => {
              return (
