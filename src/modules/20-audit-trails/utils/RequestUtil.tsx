...
import type { AuditEventDTO, AuditFilterProperties, Environment } from 'services/audit'
...
export const envTypeToLabelMap: Record<Environment['type'], StringKeys> = {
  PreProduction: 'common.envType.nonProduction',
  Production: 'common.envType.production'
}
